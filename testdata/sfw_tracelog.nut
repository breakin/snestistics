...
function trace_log_init(replay) {
	...
	replay.set_breakpoint(0x8797D7);
	replay.set_breakpoint(0x879C54);
	replay.set_breakpoint(0x87C779);
	replay.set_breakpoint(0x8796E9);
	replay.set_breakpoint(0x87983C);
	replay.set_breakpoint(0x87964A);
	replay.set_breakpoint(0x83A7E9);
	replay.set_breakpoint(0x879F4C);
	replay.set_breakpoint(0x879F6F);
	replay.set_breakpoint(0x82EF64);
	replay.set_breakpoint(0x878BD2);
	replay.set_breakpoint(0x87885C);
	replay.set_breakpoint(0x878D8A);
	replay.set_breakpoint(0x878D92);
	replay.set_breakpoint(0x878D95);
	replay.set_breakpoint(0x87883D);
	replay.set_breakpoint(0x87BB7A);
	replay.set_breakpoint(0x8786CB);
	replay.set_breakpoint(0x87872F);
	replay.set_breakpoint(0x878716);
	replay.set_breakpoint(0x87B0E1);
	replay.set_breakpoint(0x82F13D);
	replay.set_breakpoint(0x80B4B6);
	replay.set_breakpoint(0x80B503);
	replay.set_breakpoint(0x80B3EB);
	replay.set_breakpoint(0x80B2FF);
	replay.set_breakpoint(0x80B5C7);
	replay.set_breakpoint(0x80B579);
	replay.set_breakpoint(0x80BAF4);
	replay.set_breakpoint(0x80BE0C);
	replay.set_breakpoint(0x80AE41);
	replay.set_breakpoint(0x80B8FD);
	replay.set_breakpoint(0x80B929);
	replay.set_breakpoint(0x80B954);
	replay.set_breakpoint(0x80B98E);
}
